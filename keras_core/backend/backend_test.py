...
class BackendTestCase(test_case.TestCase):
    def reload_backend_module(self, mocked_backend_value=None):
        """
        Helper function to reload the backend module. If `mocked_backend_value` is provided, it will mock the backend,
        otherwise, it will reload the backend without mocking.
        """
        if mocked_backend_value is not None:
            with patch(
    ...
    def test_real_jax_backend_function_import(self):
        # Reload the backend module without mocking it
        self.reload_backend_module()
    ...
    def test_real_tensorflow_backend_function_import(self):
        # Reload the backend module without mocking it
        self.reload_backend_module()
    ...
    def test_real_numpy_backend_function_import(self):
        # Reload the backend module without mocking it
        self.reload_backend_module()
    ...
    def test_real_torch_backend_function_import(self):
        # Reload the backend module without mocking it
        self.reload_backend_module()
    ...
    def test_real_invalid_backend(self):
        with self.assertRaisesRegex(
            ValueError, "Unable to import backend : invalid_backend"
        ):
            # Attempt to reload the backend module without mocking it
            self.reload_backend_module(mocked_backend_value="invalid_backend")
...
#         # Check for the presence of convert_to_tensor in the imported backend module
#         self.assertTrue(hasattr(backend_module.core, "convert_to_tensor"))
#         self.assertTrue(hasattr(backend_module.backend.jax.core, "convert_to_tensor"))
...
#         # Check for the presence of convert_to_tensor in the imported backend module
#         self.assertTrue(hasattr(backend_module.core, "convert_to_tensor"))
#         self.assertTrue(hasattr(backend_module.backend.tensorflow.core, "convert_to_tensor"))
...
#         # Check for the presence of convert_to_tensor in the imported backend module
#         self.assertTrue(hasattr(backend_module.core, "convert_to_tensor"))
#         self.assertTrue(hasattr(backend_module.backend.numpy.core, "convert_to_tensor"))
...
#         # Check for the presence of convert_to_tensor in the imported backend module
#         self.assertTrue(hasattr(backend_module.core, "convert_to_tensor"))
#         self.assertTrue(hasattr(backend_module.backend.torch.core, "convert_to_tensor"))
