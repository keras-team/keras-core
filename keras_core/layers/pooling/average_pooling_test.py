...
class AveragePoolingCorrectnessTest(testing.TestCase, parameterized.TestCase):
    ...
    def test_average_pooling_1d(self, pool_size, strides, padding, data_format):
    ...
    def test_average_pooling_2d(self, pool_size, strides, padding, data_format):
    ...
    def test_average_pooling_3d(self, pool_size, strides, padding, data_format):
